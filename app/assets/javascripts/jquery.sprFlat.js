    // here we go!
    $.mikeyTheme = function(element, options) {
        ...
        plugin.init = function() {
            ...
            $('a.full-screen').click(function(el) {
                console.log("click function launched")
        ...
        plugin.chatWindow = function() {
            ...
            function appendMsg (msg) {
                $('.chat-box .chat-messages').append('<li class="chat-me"><p class="avatar"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/roybarberuk/48.jpg" alt="mikeyPatterson"></p><p class="chat-name">mikeyPatterson <span class="chat-time">Now</span></p><p class="chat-txt">'+ msg +'</p></li>');
            }
        }
        ...
        plugin.launchFullScreen = function (el) {  
            console.log("Full screen function launched")         
...
-1*delta}if(orgEvent.wheelDeltaY!==undefined)deltaY=orgEvent.wheelDeltaY/120;if(orgEvent.wheelDeltaX!==undefined)deltaX=-1*orgEvent.wheelDeltaX/120;args.unshift(event,delta,deltaX,deltaY);return($.event.dispatch||$.event.handle).apply(this,args)}})(jQuery);
    ...
    $.fn.mikeyTheme = function(options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function() {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('mikeyTheme')) {

                // create a new instance of the plugin
                // pass the DOM element and the user-provided options as arguments
                var plugin = new $.mikeyTheme(this, options);

                // store a reference to the plugin object
                // element.data('mikeyTheme').publicMethod(arg1, arg2, ... argn) or
                // element.data('mikeyTheme').settings.propertyName
                $(this).data('mikeyTheme', plugin);
