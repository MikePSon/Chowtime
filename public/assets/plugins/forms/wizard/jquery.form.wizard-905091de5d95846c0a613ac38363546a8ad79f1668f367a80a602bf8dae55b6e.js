	...
	$.widget("ui.formwizard", {
		...
		_init: function() {
			...
			if(!this.options.disableUIStyles){
				this.element.addClass("ui-helper-reset ui-widget ui-panel-body ui-helper-reset ui-corner-all");
			...
			if(this.options.showSteps) {
				...
				function showSteps(wizsteps, steps, stepNum) {
					for(var i = 0; i < stepNum; i++) {
						...
						if(i+1 == stepNum) {
							wizsteps.append(
								'<div class="wstep last-child" data-step-num="'+i+'"><div class="donut"><i class="'+stepIcon+' s24"></i></div><span class="txt">'+stepText+'</span></div>'
							);
						} else {
							wizsteps.append(
								'<div class="wstep" data-step-num="'+i+'"><div class="donut"><i class="'+stepIcon+' s24"></i></div><span class="txt">'+stepText+'</span></div>'
							);
						}
					}
				}
